...
ActiveRecord::Schema.define(version: 2022_10_28_101949) do
  ...
  create_table "goods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["way_id"], name: "index_goods_on_way_id"
  end
  ...
  create_table "roots", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_roots_on_user_id"
  end
  ...
  add_foreign_key "goods", "ways"
  add_foreign_key "roots", "users"
